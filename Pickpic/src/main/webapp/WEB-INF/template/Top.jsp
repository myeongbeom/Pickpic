...
<script src="<c:url value='/js/Top.js'/>"></script>
		...
		<header class="container-fluid header_top " >
				...
				<div class="menu_all_wrap_position">
					...
					<div class="logo"><a href="<c:url value='/PickPic/friends/Place.bbs'/>"><img src="<c:url value='/resources/images/a1.PNG'/>" /></a></div>
							...
							<div class="menu_login_in">
								...
								<div class="login_wrap">
									<ul>
										...
										<li><a href="<c:url value='/PickPic/login/Login2.bbs'/>">SING UP</a>
									</ul>
								</div>
						 </div>
